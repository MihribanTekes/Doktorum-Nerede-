...
<head>
	...
	<body>
		<form method="post" action="goz_hastaliklari.php" enctype="multipart/form-data">
		    
			(Goz Hastaliklari)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into goz_hastaliklari(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
