...
<head>
	...
	<body>
		<form method="post" action="mikrobiyoloji.php" enctype="multipart/form-data">
		    
			(Mikrobiyoloji)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into mikrobiyoloji(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
