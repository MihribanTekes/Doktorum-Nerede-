...
<head>
	...
	<body>
		<form method="post" action="cocuk_psikolojisi.php" enctype="multipart/form-data">
		    
			(Cocuk Psikiyatri)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into cocuk_psikiyatri(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
