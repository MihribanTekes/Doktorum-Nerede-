...
<head>
	...
	<body>
		<form method="post" action="kulak_burun_bogaz.php" enctype="multipart/form-data">
		    
			(Kulak Burun Boðaz)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into kulak_burun_bogaz(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
