...
<head>
	...
	<body>
		<form method="post" action="acil_tip.php" enctype="multipart/form-data">
		    
			(Acil Tip)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into acil_tip(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
