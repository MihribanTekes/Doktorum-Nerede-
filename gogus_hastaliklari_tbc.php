...
<head>
	...
	<body>
		<form method="post" action="gogus_hastaliklari_tbc.php" enctype="multipart/form-data">
		    
			(Gogus Hastaliklari)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into gogus_hastaliklari_tbc(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
