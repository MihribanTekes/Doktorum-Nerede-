...
<head>
	...
	<body>
		<form method="post" action="beyin_cerrahi.php">
			(beyin cerrahi)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into beyin_cerrahi(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
