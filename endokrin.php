...
<head>
	...
	<body>
		<form method="post" action="endokrin.php" enctype="multipart/form-data">
		    
			(Endokrin)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into endokrin(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
