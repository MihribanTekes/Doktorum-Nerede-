...
<head>
	...
	<body>
		<form method="post" action="cildiye.php" enctype="multipart/form-data">
		    
			(Cildiye)UNVAN Giriniz: <input type="text"name="unvan" /><br />
...
if($kontrol)
{
	...
	mysql_query("insert into cildiye(unvan,ad,soyad,oda,resim)values('$unvan','$ad','$soyad','$oda','$resim')",$baglanti)or die("Veri eklenemedi".mysql_error());
	echo'Veri eklendi';
